...
class JavaPlaygroundExercise extends Component {
  ...
  sendCodeinSandBox = () => {
    ...
    this.setState({ pendingOutput: true })
      ...
      fetch(url, {
        ...
        .then(async res => {
          ...
          if (
            ...
            this.setState({ pendingOutput: false })
  ...
  render() {
    ...
    let pendingOutput = this.state.pendingOutput
        ...
        <Grid container spacing={24}>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <TextField
              ...
              value={
                output ||
                (pendingOutput ? '👩🏻‍🚀 bringing your output from Mars...' : '')
              }
              fullWidth
              margin="normal"
              variant="outlined"
